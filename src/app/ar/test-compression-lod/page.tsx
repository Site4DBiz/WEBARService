...
export default function TestCompressionLODPage() {
  ...
  const handleCompress = useCallback(async (options: CompressionOptions) => {
    ...
    try {
      const result = await modelLoaderRef.current.compressModel(
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Load a model to test compression and LOD features
              </CardDescription>
            </CardHeader>
            <CardContent>
                ...
                {lodStatistics && (
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-2 text-sm">
                    ...
                    <div className="p-2 bg-muted rounded">
                      ...
                      <p className="font-semibold">{lodStatistics.activeVertices.toLocaleString()}</p>
                    </div>
                    <div className="p-2 bg-muted rounded">
        ...
        <div>
          ...
          <Alert className="mt-4">
            ...
            <AlertDescription>
              Load a 3D model first, then experiment with compression settings and LOD configurations
