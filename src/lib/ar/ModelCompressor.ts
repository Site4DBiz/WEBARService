...
export class ModelCompressor {
  ...
  private async optimizeMaterials(model: THREE.Object3D): Promise<void> {
    ...
    model.traverse((child) => {
      if (child instanceof THREE.Mesh && child.material) {
        ...
        child.material =
          optimizedMaterials.length === 1 ? optimizedMaterials[0] : optimizedMaterials
      }
    })
  }
  ...
  private async applyDracoCompression(model: THREE.Object3D, quantization: any): Promise<void> {
