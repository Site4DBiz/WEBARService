...
import { ImageTracker, ImageFeature, TrackingSettings, OptimizationResult } from '@/lib/ar/ImageTracker'
          ...
          {optimizationConfig.enableSmoothing && (
            <div>
              ...
              <input
                ...
                className="w-full"
              />
              <span className="text-sm text-gray-400">{optimizationConfig.smoothingFactor.toFixed(1)}</span>
            </div>
          )}
          ...
          {optimizationConfig.enableJitterReduction && (
            <div>
              ...
              <input
                ...
                className="w-full"
              />
              <span className="text-sm text-gray-400">{optimizationConfig.jitterThreshold.toFixed(3)}</span>
            </div>
          )}
        </div>
      </div>
